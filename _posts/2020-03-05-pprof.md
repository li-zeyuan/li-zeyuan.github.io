...
- 直接生成：`export PPROF_TMPDIR=./; go tool pprof http://127.0.0.1:31777/debug/pprof/profile?second=30`



#### 内存：

- 方式1: `export PPROF_TMPDIR=./; go tool pprof --inuse_space http://127.0.0.1:3/debug/pprof/heap`
