...
<br>
两个阶段
- Prepare (提案) 阶段：Proposer 选择一个唯一递增的提案编号 n，向大多数 Acceptor 发送 Prepare 请求。 Acceptor 收到请求后，如果 n 大于自己响应的最大提案编号，回复响应并不会接受小于 n 编号提议。
...
👉 选一个 Leader，所有写操作都走 Leader，再复制到多数节点
