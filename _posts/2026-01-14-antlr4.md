...
监听器（[Listener](https://github.com/li-zeyuan/design-pattern/tree/master/behavioralpattern/observer)）/访问者（[Visitor](https://github.com/li-zeyuan/designPattern/tree/master/behavioralpattern/visitor)）：遍历语法树，执行自定义逻辑
...
> Listener 是antler内置的一种观察者（Observer）模式实现，用与语法树的深度遍历
